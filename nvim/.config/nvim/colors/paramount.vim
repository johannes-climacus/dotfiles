...
let s:light_black     = { "gui": "#262626", "cterm": "238" }
let s:lighter_black   = { "gui": "#4E4E4E", "cterm": "241" }
let s:light_gray      = { "gui": "#A8A8A8", "cterm": "249" }
let s:lighter_gray    = { "gui": "#C6C6C6", "cterm": "253" }
let s:lightest_gray   = { "gui": "#EEEEEE", "cterm": "256" }
...
call s:h("Special",       {"fg": s:norm_subtle, "cterm": "italic", "gui": "italic"})
